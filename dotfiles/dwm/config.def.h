...
static const unsigned int gappx[]   = { 24 };   /* default gap between windows in pixels, this can be customized for each tag */
...
static const char col_gray2[]       = "#333344";
static const char col_gray3[]       = "#aaaabb";
static const char col_gray4[]       = "#ddddee";
static const char col_pink[]        = "#fe37c8";
